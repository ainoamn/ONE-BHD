...
> **الحالة:** تجريبي على البوابة فقط. ليست هوية OIDC مركزية بعد.
...
1. نطاق رسمي `bhd-om.com` وكل المنتجات تحت فروع منه، **أو**
2. خدمة **BHD Identity** مستقلة (OpenID Connect): البوابة وحسابي ووازن عملاء `client_id` منفصلون.
3. لا تُقرأ قواعد بيانات المنتجات من البوابة.
4. MFA/مفاتيح مرور بعد استقرار Google.

حتى ذلك الحين: المستخدم يسجّل بـ Google في كل موقع مرة؛ الهوية هي بريد Google نفسه، والجلسات منفصلة.
