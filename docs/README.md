...
| الملف | الغرض |
|---|---|
| [BHD-IDENTITY-SSO.md](BHD-IDENTITY-SSO.md) | **المواصفة المعتمدة** لهوية BHD الموحّدة (OIDC) ولوحة `/admin`. تُنسخ كما هي إلى بقية المواقع |
| [BHD-APP-SWITCHER.md](BHD-APP-SWITCHER.md) | **المواصفة المعتمدة** لمشغّل التطبيقات بعد الدخول (تسع نقاط بجانب الحساب). تُنسخ كما هي مع `lib/bhd/apps.ts` |
