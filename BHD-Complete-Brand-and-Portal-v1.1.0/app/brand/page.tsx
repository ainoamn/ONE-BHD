...
const systemItems = [
  ["الشعارات", "الشعار الرئيسي، الرمز، النسخة المكتوبة، الأحادية، المعكوسة، وشعار متجر BHD."],
      ...
      <section className="brand-guide-intro">
        ...
        <article className="brand-guide-copy">
          ...
          <div className="brand-equation">
            <span><b>BHD</b><small>بن حمود للتطوير</small></span>
            <i>=</i>
            <span><b>BHD</b><small>ابنِ أحلامًا أكبر</small></span>
          </div>
        </article>
      </section>
